...
use Rack::Cors do
  allow do
    origins '*'
    resource "#{root_path}/*", :headers => :any, :methods => [:get, :post, :put, :delete]
  end
end
...
get "#{root_path}/tables/:table" do |table|
	connect(datasource) do |connection|
		begin
